...
<head>
  ...
  <link rel="stylesheet" href=<?= $_ENV['APP_URL'] . "/public/dist/output.css" ?>>
  <title>Page Not Found 404!</title>
</head>

<body class="h-full w-full">
  <div class="flex items-center justify-center h-full w-full min-h-screen bg-indigo-500  bg-fixed bg-cover bg-bottom error-bg"
