                ...
                <a href="<?= $_ENV['APP_URL'] . "/dashboard" ?>" class="flex ml-2 gap-2 items-center justify-center">
                    ...
                    <svg width="35" height="35" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#546F7B" />
                        <path d="M48.7 18.66H53.47V23.9H48.7V18.66ZM75.17 18.87H79.71V23.95H75.17V18.87Z"
                            fill="#546F7B" />
                    ...
                    <span class="font-poppins tracking-wider text-2xl text-slate-200 font-bold"><span
            ...
            <ul class=" space-y-3 ml-[2%] mb-[10%] text-lg ">
                <li>
                    <a href="#"
                        ...
                        <svg class="w-5 h-5 text-purple-600 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#FACA15" viewBox="0 0 22 21">
                            <path
                ...
                <li>
                    <a href="#"
                        ...
                        <svg class="flex-shrink-0 w-5 h-5 text-yellow-300 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#FACA15" viewBox="0 0 18 16">
                            <path stroke="#FACA15" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="#"
                        ...
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#FACA15" viewBox="0 0 20 20">
